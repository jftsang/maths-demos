...
$$
\frac{\mathrm{d}n}{\mathrm{d}t} = n(1-n) - \frac{\beta n}{\alpha + n}
$$
...
def insects_demo(alpha, beta):
    ...
    axs[0].set_ylim((-.2, .2))
    axs[0].grid()
    axs[0].set_title(r'$\frac{\mathrm{d}n}{\mathrm{d}t}$ against $n$')
    axs[0].set_xlabel(r'$n$')
    axs[0].set_ylabel(r'$\frac{\mathrm{d}n}{\mathrm{d}t}$')

    for sol in sols:
        assert sol.success, sol.message
        axs[1].plot(sol.t, sol.y[0, :], c='gray')

    axs[1].grid()
    axs[1].set_xlabel(r'$t$')
    axs[1].set_ylabel(r'$n(t)$')
    plt.show()
```
